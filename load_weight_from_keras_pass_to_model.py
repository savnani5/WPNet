...
parser.add_argument('--input', default='/content/gdrive/My\ Drive/data/manual_0/images/img__0_1549119348321541200.png', type=str, help='Input filename or folder.')
